...
<li class="nav-item">
<a href="about.php"><font size="4">用戶管理</font></a>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
</li>
<!-- <li class="nav-item">
...
<center><a href="admin.php"><input type="button" value="返回"></a>&nbsp<input type="submit" value="儲存變更"></center>
</form>
