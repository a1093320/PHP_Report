...
?>
<?php
if(isset($_SESSION["per"])&&isset($_SESSION["complete"])){
    if($_SESSION["per"]!="yes"||$_SESSION["complete"]!="Yes"){
...
<p><center><font size="10">訂單建立完成</font></p>
<form action="index.php" method="post" enctype="multipart/form-data"></br>
        <p><center><font size="6">太合子感謝您的光臨</font></center></p>
        <p><center><font size="5">備貨可能長達7天，時間較長敬請見諒!</font></center></p>
        </br><input type="submit" name="submit" value="回首頁">
</form>
</center>
</body>
</html>