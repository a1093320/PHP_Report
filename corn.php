...
<div class="about-img">
<img src="06_冷凍水餃_甜玉米_v1.jpg" width="70%" alt="Choose">
...
<p><font size="5">50粒/包</font><font size="4"></br></br>成分:豬肉、高麗菜、蔥、薑、玉米粒、胡蘿蔔粉、麵粉、油、鹽</br></br>保存方式:密封置於冷凍-18度以下即可</br></br>保存期限:30天</br></br>烹煮流程:不須解涷直接放入滾水中，開大火輕輕翻動水餃避免黏鍋，靜待6~8分鐘即可</br></br></font><font size="5" color='red'>本店餡料使用台灣豬肉</br>不添加防腐劑及人工香料</font></p>
<input type=submit name=submit value="加入購物車">&nbsp&nbsp<input type="number" size="2" name="number" min="1" max="10">&nbsp&nbsp250元/包
</form>
</div>
</div>
</div>
