...
?>
<center>
<font size="10">歷史訂單</font>
<br><br>
<table style="width:50%">
<tr>
<th><center><font size='5'>品項</font></center></th><th><center><font size='5'>數量</font></center></th><th><center><font size='5'>物流狀態</font></center></th><th><center><font size='5'>金額</font></center></th>
</tr>
<?php
    while($row=mysqli_fetch_assoc($result)){
        ...
        echo "<td><center><font size='5'>".$state."</font></center></td>";
...
<center>
<a href="account.php"><font size="4"><input type="button" value="查詢用戶資料"></font></a>
</center>
</body>
</html>